      ...
      <div className="w-full mx-auto">
        ...
        <div className="grid md:grid-cols-12 gap-8">
          {displayedProjects.map((project, index) => (
            ...
            >
              <div className="h-56 overflow-hidden bg-surface-container-low flex items-center justify-center">
              ...
              <div className="p-8 flex-grow flex flex-col">
                ...
                <Link href={project.link} className="flex items-center gap-2 text-primary font-label-caps text-label-caps hover:gap-4 transition-all w-fit">
